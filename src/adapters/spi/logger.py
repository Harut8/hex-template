...
class RouterLoggingMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        _response_logging, response = await self._log_response(call_next, request, request_id)
    ...
    async def _log_response(self, call_next: Callable, request: Request, request_id: str):
